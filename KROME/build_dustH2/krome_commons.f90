...
module krome_commons
  ...
  !  KROME 14.08.dev on 2019-09-23 15:22:44
  !  Changeset xxxxxxx
  ...
  integer,parameter::idx_Cj=198
  integer,parameter::idx_FEj=199
  integer,parameter::idx_Hj=200
  integer,parameter::idx_HEj=201
  integer,parameter::idx_MGj=202
  integer,parameter::idx_Nj=203
  integer,parameter::idx_NAj=204
  integer,parameter::idx_Oj=205
  integer,parameter::idx_Sj=206
  integer,parameter::idx_SIj=207
  integer,parameter::idx_H3j=208
  integer,parameter::idx_HCOj=209
  integer,parameter::idx_CLj=210
  integer,parameter::idx_Pj=211
  integer,parameter::idx_COj=212
  integer,parameter::idx_H2j=213
  integer,parameter::idx_NOj=214
  integer,parameter::idx_O2j=215
  integer,parameter::idx_CH2j=216
  integer,parameter::idx_H2Sj=217
  integer,parameter::idx_HCSj=218
  integer,parameter::idx_HNOj=219
  integer,parameter::idx_NH2j=220
  integer,parameter::idx_OCSj=221
  integer,parameter::idx_C2H2j=222
  integer,parameter::idx_CH3j=223
  integer,parameter::idx_NH3j=224
  integer,parameter::idx_C2H2Oj=225
  integer,parameter::idx_CH2O2j=226
  integer,parameter::idx_C2H3Nj=227
  integer,parameter::idx_C2H4j=228
  integer,parameter::idx_C4H2j=229
  integer,parameter::idx_H3COj=230
  integer,parameter::idx_CH4Oj=231
  integer,parameter::idx_C2H4Oj=232
  integer,parameter::idx_C3H4j=233
  integer,parameter::idx_CH5Nj=234
  integer,parameter::idx_C2H5OHj=235
  integer,parameter::idx_CH3OCH3j=236
  integer,parameter::idx_CHj=237
  integer,parameter::idx_CCLj=238
  integer,parameter::idx_C2j=239
  integer,parameter::idx_CLOj=240
  integer,parameter::idx_CPj=241
  integer,parameter::idx_CFj=242
  integer,parameter::idx_CSj=243
  integer,parameter::idx_CNj=244
  integer,parameter::idx_NSj=245
  integer,parameter::idx_PHj=246
  integer,parameter::idx_POj=247
  integer,parameter::idx_SICj=248
  integer,parameter::idx_SINj=249
  integer,parameter::idx_SISj=250
  integer,parameter::idx_SOj=251
  integer,parameter::idx_C3j=252
  integer,parameter::idx_C2Sj=253
  integer,parameter::idx_C2Oj=254
  integer,parameter::idx_CCPj=255
  integer,parameter::idx_C2Hj=256
  integer,parameter::idx_HOCj=257
  integer,parameter::idx_C2Nj=258
  integer,parameter::idx_CNCj=259
  integer,parameter::idx_HCPj=260
  integer,parameter::idx_SIC2j=261
  integer,parameter::idx_SINCj=262
  integer,parameter::idx_HPOj=263
  integer,parameter::idx_HCNj=264
  integer,parameter::idx_CHSIj=265
  integer,parameter::idx_SIH2j=266
  integer,parameter::idx_C3Hj=267
  integer,parameter::idx_C4j=268
  integer,parameter::idx_C3Oj=269
  integer,parameter::idx_C3Sj=270
  integer,parameter::idx_H2COj=271
  integer,parameter::idx_H2SIOj=272
  integer,parameter::idx_HCNHj=273
  integer,parameter::idx_SIC2Hj=274
  integer,parameter::idx_SIC3j=275
  integer,parameter::idx_CH2SIj=276
  integer,parameter::idx_SIH3j=277
  integer,parameter::idx_C2H2Nj=278
  integer,parameter::idx_C2H3j=279
  integer,parameter::idx_C3H2j=280
  integer,parameter::idx_H2C3j=281
  integer,parameter::idx_C4Hj=282
  integer,parameter::idx_C5j=283
  integer,parameter::idx_C4Sj=284
  integer,parameter::idx_PC2Hj=285
  integer,parameter::idx_C3Nj=286
  integer,parameter::idx_C4Nj=287
  integer,parameter::idx_C3HNj=288
  integer,parameter::idx_HNCj=289
  integer,parameter::idx_SIC3Hj=290
  integer,parameter::idx_SIC4j=291
  integer,parameter::idx_SIC2H2j=292
  integer,parameter::idx_SICH3j=293
  integer,parameter::idx_HC2NCHj=294
  integer,parameter::idx_C3H3j=295
  integer,parameter::idx_H3C3j=296
  integer,parameter::idx_C5Hj=297
  integer,parameter::idx_C6j=298
  integer,parameter::idx_C2H3Oj=299
  integer,parameter::idx_C2H5j=300
  integer,parameter::idx_C3H3Nj=301
  integer,parameter::idx_C5H2j=302
  integer,parameter::idx_C4H3j=303
  integer,parameter::idx_C6Hj=304
  integer,parameter::idx_C7j=305
  integer,parameter::idx_CH4Nj=306
  integer,parameter::idx_C5HNj=307
  integer,parameter::idx_C7Hj=308
  integer,parameter::idx_C8j=309
  integer,parameter::idx_COOCH4j=310
  integer,parameter::idx_C2H5Oj=311
  integer,parameter::idx_C8Hj=312
  integer,parameter::idx_C9j=313
  integer,parameter::idx_C5H3j=314
  integer,parameter::idx_C6H2j=315
  integer,parameter::idx_C6H3j=316
  integer,parameter::idx_C2H6COj=317
  integer,parameter::idx_C9Hj=318
  integer,parameter::idx_C10j=319
  integer,parameter::idx_C7H3j=320
  integer,parameter::idx_C8H2j=321
  integer,parameter::idx_C8H3j=322
  integer,parameter::idx_HCLj=323
  integer,parameter::idx_Fj=324
  integer,parameter::idx_HFj=325
  integer,parameter::idx_HSj=326
  integer,parameter::idx_NHj=327
  integer,parameter::idx_OHj=328
  integer,parameter::idx_PNj=329
  integer,parameter::idx_S2j=330
  integer,parameter::idx_SIHj=331
  integer,parameter::idx_SIOj=332
  integer,parameter::idx_H2Oj=333
  integer,parameter::idx_HNSIj=334
  integer,parameter::idx_S2Hj=335
  integer,parameter::idx_PH2j=336
  integer,parameter::idx_H2CSj=337
  integer,parameter::idx_H2S2j=338
  integer,parameter::idx_HSIOj=339
  integer,parameter::idx_C4Pj=340
  integer,parameter::idx_HCO2j=341
  integer,parameter::idx_PCH3j=342
  integer,parameter::idx_CH4j=343
  integer,parameter::idx_C2NHj=344
  integer,parameter::idx_SIH4j=345
  integer,parameter::idx_NH4j=346
  integer,parameter::idx_H2NCj=347
  integer,parameter::idx_C3H2Nj=348
  integer,parameter::idx_C7H2j=349
  integer,parameter::idx_C5H4j=350
  integer,parameter::idx_C7HNj=351
  integer,parameter::idx_C9H2j=352
  integer,parameter::idx_C7H4j=353
  integer,parameter::idx_C9HNj=354
  integer,parameter::idx_N2j=355
  integer,parameter::idx_CO2j=356
  integer,parameter::idx_HEHj=357
  integer,parameter::idx_SO2j=358
  integer,parameter::idx_C6H5j=359
  integer,parameter::idx_C5H5j=360
  integer,parameter::idx_N2Hj=361
  integer,parameter::idx_NO2j=362
  integer,parameter::idx_PC2H2j=363
  integer,parameter::idx_PNH2j=364
  integer,parameter::idx_PCH2j=365
  integer,parameter::idx_HC2Sj=366
  integer,parameter::idx_HC3Sj=367
  integer,parameter::idx_H3CSj=368
  integer,parameter::idx_HC4Sj=369
  integer,parameter::idx_SIFj=370
  integer,parameter::idx_SINH2j=371
  integer,parameter::idx_SIC2H3j=372
  integer,parameter::idx_SIC3H2j=373
  integer,parameter::idx_C2HOj=374
  integer,parameter::idx_H3Oj=375
  integer,parameter::idx_H3Sj=376
  integer,parameter::idx_HOCSj=377
  integer,parameter::idx_CH5Oj=378
  integer,parameter::idx_NCOj=379
  integer,parameter::idx_HNCOj=380
  integer,parameter::idx_C2N2j=381
  integer,parameter::idx_O2Hj=382
  integer,parameter::idx_CH5j=383
  integer,parameter::idx_H2CLj=384
  integer,parameter::idx_H2Fj=385
  integer,parameter::idx_CH3O2j=386
  integer,parameter::idx_H2POj=387
  integer,parameter::idx_PNH3j=388
  integer,parameter::idx_PCH4j=389
  integer,parameter::idx_PC2H3j=390
  integer,parameter::idx_HSISj=391
  integer,parameter::idx_HSOj=392
  integer,parameter::idx_HNSj=393
  integer,parameter::idx_HPNj=394
  integer,parameter::idx_H2NOj=395
  integer,parameter::idx_NAH2Oj=396
  integer,parameter::idx_PH3j=397
  integer,parameter::idx_SINCHj=398
  integer,parameter::idx_HSIO2j=399
  integer,parameter::idx_HSO2j=400
  integer,parameter::idx_HC3Oj=401
  integer,parameter::idx_PC3Hj=402
  integer,parameter::idx_H3S2j=403
  integer,parameter::idx_H3SIOj=404
  integer,parameter::idx_PC4Hj=405
  integer,parameter::idx_NH2CNHj=406
  integer,parameter::idx_SIC4Hj=407
  integer,parameter::idx_SICH4j=408
  integer,parameter::idx_SIH5j=409
  integer,parameter::idx_C2H4Nj=410
  integer,parameter::idx_NH2CH2Oj=411
  integer,parameter::idx_C2H6j=412
  integer,parameter::idx_C3H4Nj=413
  integer,parameter::idx_C3H5j=414
  integer,parameter::idx_C4H4j=415
  integer,parameter::idx_CH6Nj=416
  integer,parameter::idx_C5H2Nj=417
  integer,parameter::idx_C4H4Nj=418
  integer,parameter::idx_H5C2O2j=419
  integer,parameter::idx_C2H5OH2j=420
  integer,parameter::idx_CH3OCH4j=421
  integer,parameter::idx_C7H2Nj=422
  integer,parameter::idx_C3H6OHj=423
  integer,parameter::idx_C6H4Nj=424
  integer,parameter::idx_C9H3j=425
  integer,parameter::idx_C7H5j=426
  integer,parameter::idx_C8H4Nj=427
  integer,parameter::idx_C9H2Nj=428
  integer,parameter::idx_C6H7j=429
  integer,parameter::idx_NAH2j=430
  integer,parameter::idx_PC2H4j=431
  integer,parameter::idx_C4H5j=432
  integer,parameter::idx_H2CCLj=433
  integer,parameter::idx_PC4H2j=434
  integer,parameter::idx_C6H4j=435
  integer,parameter::idx_C8H4j=436
  integer,parameter::idx_C9H4j=437
  integer,parameter::idx_C4H7j=438
  integer,parameter::idx_HC4Nj=439
  integer,parameter::idx_HC4Oj=440
  integer,parameter::idx_C5Nj=441
  integer,parameter::idx_H2C4Nj=442
  integer,parameter::idx_H3C4Nj=443
  integer,parameter::idx_C7Nj=444
  integer,parameter::idx_C5H3Nj=445
  integer,parameter::idx_C9Nj=446
  integer,parameter::idx_C7H3Nj=447
  integer,parameter::idx_C9H3Nj=448
  integer,parameter::idx_OCSjH2=449
  integer,parameter::idx_H2C3Oj=450
  integer,parameter::idx_H3C3Oj=451
  integer,parameter::idx_C5H4Nj=452
  integer,parameter::idx_C8H5j=453
  integer,parameter::idx_C9H5j=454
  integer,parameter::idx_CR=455
  integer,parameter::idx_g=456
  integer,parameter::idx_Tgas=457
  integer,parameter::idx_dummy=458
  integer,parameter::nrea=4436
  integer,parameter::nmols=454
  integer,parameter::nspec=458
