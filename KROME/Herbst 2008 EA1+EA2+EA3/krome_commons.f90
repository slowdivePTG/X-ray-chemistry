...
module krome_commons
  ...
  !  KROME 14.08.dev on 2019-03-29 11:56:58
  !  Changeset xxxxxxx
  ...
  integer,parameter::idx_CR=453
  integer,parameter::idx_g=454
  integer,parameter::idx_Tgas=455
  integer,parameter::idx_dummy=456
  integer,parameter::nrea=4429
  integer,parameter::nmols=452
