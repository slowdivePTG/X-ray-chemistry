...
module krome_commons
  ...
  !  KROME 14.08.dev on 2019-09-17 14:46:00
  !  Changeset xxxxxxx
  ...
  integer,parameter::idx_H_DUSTH_DUST=197
  integer,parameter::idx_O_DUST=198
  integer,parameter::idx_O_DUSTH_DUST=199
  integer,parameter::idx_H_DUSTH_DUSTO_DUST=200
  integer,parameter::idx_O_DUSTO_DUST=201
  integer,parameter::idx_Cj=202
  integer,parameter::idx_FEj=203
  integer,parameter::idx_Hj=204
  integer,parameter::idx_HEj=205
  integer,parameter::idx_MGj=206
  integer,parameter::idx_Nj=207
  integer,parameter::idx_NAj=208
  integer,parameter::idx_Oj=209
  integer,parameter::idx_Sj=210
  integer,parameter::idx_SIj=211
  integer,parameter::idx_H3j=212
  integer,parameter::idx_HCOj=213
  integer,parameter::idx_CLj=214
  integer,parameter::idx_Pj=215
  integer,parameter::idx_COj=216
  integer,parameter::idx_H2j=217
  integer,parameter::idx_NOj=218
  integer,parameter::idx_O2j=219
  integer,parameter::idx_CH2j=220
  integer,parameter::idx_H2Sj=221
  integer,parameter::idx_HCSj=222
  integer,parameter::idx_HNOj=223
  integer,parameter::idx_NH2j=224
  integer,parameter::idx_OCSj=225
  integer,parameter::idx_C2H2j=226
  integer,parameter::idx_CH3j=227
  integer,parameter::idx_NH3j=228
  integer,parameter::idx_C2H2Oj=229
  integer,parameter::idx_CH2O2j=230
  integer,parameter::idx_C2H3Nj=231
  integer,parameter::idx_C2H4j=232
  integer,parameter::idx_C4H2j=233
  integer,parameter::idx_H3COj=234
  integer,parameter::idx_CH4Oj=235
  integer,parameter::idx_C2H4Oj=236
  integer,parameter::idx_C3H4j=237
  integer,parameter::idx_CH5Nj=238
  integer,parameter::idx_C2H5OHj=239
  integer,parameter::idx_CH3OCH3j=240
  integer,parameter::idx_CHj=241
  integer,parameter::idx_CCLj=242
  integer,parameter::idx_C2j=243
  integer,parameter::idx_CLOj=244
  integer,parameter::idx_CPj=245
  integer,parameter::idx_CFj=246
  integer,parameter::idx_CSj=247
  integer,parameter::idx_CNj=248
  integer,parameter::idx_NSj=249
  integer,parameter::idx_PHj=250
  integer,parameter::idx_POj=251
  integer,parameter::idx_SICj=252
  integer,parameter::idx_SINj=253
  integer,parameter::idx_SISj=254
  integer,parameter::idx_SOj=255
  integer,parameter::idx_C3j=256
  integer,parameter::idx_C2Sj=257
  integer,parameter::idx_C2Oj=258
  integer,parameter::idx_CCPj=259
  integer,parameter::idx_C2Hj=260
  integer,parameter::idx_HOCj=261
  integer,parameter::idx_C2Nj=262
  integer,parameter::idx_CNCj=263
  integer,parameter::idx_HCPj=264
  integer,parameter::idx_SIC2j=265
  integer,parameter::idx_SINCj=266
  integer,parameter::idx_HPOj=267
  integer,parameter::idx_HCNj=268
  integer,parameter::idx_CHSIj=269
  integer,parameter::idx_SIH2j=270
  integer,parameter::idx_C3Hj=271
  integer,parameter::idx_C4j=272
  integer,parameter::idx_C3Oj=273
  integer,parameter::idx_C3Sj=274
  integer,parameter::idx_H2COj=275
  integer,parameter::idx_H2SIOj=276
  integer,parameter::idx_HCNHj=277
  integer,parameter::idx_SIC2Hj=278
  integer,parameter::idx_SIC3j=279
  integer,parameter::idx_CH2SIj=280
  integer,parameter::idx_SIH3j=281
  integer,parameter::idx_C2H2Nj=282
  integer,parameter::idx_C2H3j=283
  integer,parameter::idx_C3H2j=284
  integer,parameter::idx_H2C3j=285
  integer,parameter::idx_C4Hj=286
  integer,parameter::idx_C5j=287
  integer,parameter::idx_C4Sj=288
  integer,parameter::idx_PC2Hj=289
  integer,parameter::idx_C3Nj=290
  integer,parameter::idx_C4Nj=291
  integer,parameter::idx_C3HNj=292
  integer,parameter::idx_HNCj=293
  integer,parameter::idx_SIC3Hj=294
  integer,parameter::idx_SIC4j=295
  integer,parameter::idx_SIC2H2j=296
  integer,parameter::idx_SICH3j=297
  integer,parameter::idx_HC2NCHj=298
  integer,parameter::idx_C3H3j=299
  integer,parameter::idx_H3C3j=300
  integer,parameter::idx_C5Hj=301
  integer,parameter::idx_C6j=302
  integer,parameter::idx_C2H3Oj=303
  integer,parameter::idx_C2H5j=304
  integer,parameter::idx_C3H3Nj=305
  integer,parameter::idx_C5H2j=306
  integer,parameter::idx_C4H3j=307
  integer,parameter::idx_C6Hj=308
  integer,parameter::idx_C7j=309
  integer,parameter::idx_CH4Nj=310
  integer,parameter::idx_C5HNj=311
  integer,parameter::idx_C7Hj=312
  integer,parameter::idx_C8j=313
  integer,parameter::idx_COOCH4j=314
  integer,parameter::idx_C2H5Oj=315
  integer,parameter::idx_C8Hj=316
  integer,parameter::idx_C9j=317
  integer,parameter::idx_C5H3j=318
  integer,parameter::idx_C6H2j=319
  integer,parameter::idx_C6H3j=320
  integer,parameter::idx_C2H6COj=321
  integer,parameter::idx_C9Hj=322
  integer,parameter::idx_C10j=323
  integer,parameter::idx_C7H3j=324
  integer,parameter::idx_C8H2j=325
  integer,parameter::idx_C8H3j=326
  integer,parameter::idx_HCLj=327
  integer,parameter::idx_Fj=328
  integer,parameter::idx_HFj=329
  integer,parameter::idx_HSj=330
  integer,parameter::idx_NHj=331
  integer,parameter::idx_OHj=332
  integer,parameter::idx_PNj=333
  integer,parameter::idx_S2j=334
  integer,parameter::idx_SIHj=335
  integer,parameter::idx_SIOj=336
  integer,parameter::idx_H2Oj=337
  integer,parameter::idx_HNSIj=338
  integer,parameter::idx_S2Hj=339
  integer,parameter::idx_PH2j=340
  integer,parameter::idx_H2CSj=341
  integer,parameter::idx_H2S2j=342
  integer,parameter::idx_HSIOj=343
  integer,parameter::idx_C4Pj=344
  integer,parameter::idx_HCO2j=345
  integer,parameter::idx_PCH3j=346
  integer,parameter::idx_CH4j=347
  integer,parameter::idx_C2NHj=348
  integer,parameter::idx_SIH4j=349
  integer,parameter::idx_NH4j=350
  integer,parameter::idx_H2NCj=351
  integer,parameter::idx_C3H2Nj=352
  integer,parameter::idx_C7H2j=353
  integer,parameter::idx_C5H4j=354
  integer,parameter::idx_C7HNj=355
  integer,parameter::idx_C9H2j=356
  integer,parameter::idx_C7H4j=357
  integer,parameter::idx_C9HNj=358
  integer,parameter::idx_N2j=359
  integer,parameter::idx_CO2j=360
  integer,parameter::idx_HEHj=361
  integer,parameter::idx_SO2j=362
  integer,parameter::idx_C6H5j=363
  integer,parameter::idx_C5H5j=364
  integer,parameter::idx_N2Hj=365
  integer,parameter::idx_NO2j=366
  integer,parameter::idx_PC2H2j=367
  integer,parameter::idx_PNH2j=368
  integer,parameter::idx_PCH2j=369
  integer,parameter::idx_HC2Sj=370
  integer,parameter::idx_HC3Sj=371
  integer,parameter::idx_H3CSj=372
  integer,parameter::idx_HC4Sj=373
  integer,parameter::idx_SIFj=374
  integer,parameter::idx_SINH2j=375
  integer,parameter::idx_SIC2H3j=376
  integer,parameter::idx_SIC3H2j=377
  integer,parameter::idx_C2HOj=378
  integer,parameter::idx_H3Oj=379
  integer,parameter::idx_H3Sj=380
  integer,parameter::idx_HOCSj=381
  integer,parameter::idx_CH5Oj=382
  integer,parameter::idx_NCOj=383
  integer,parameter::idx_HNCOj=384
  integer,parameter::idx_C2N2j=385
  integer,parameter::idx_O2Hj=386
  integer,parameter::idx_CH5j=387
  integer,parameter::idx_H2CLj=388
  integer,parameter::idx_H2Fj=389
  integer,parameter::idx_CH3O2j=390
  integer,parameter::idx_H2POj=391
  integer,parameter::idx_PNH3j=392
  integer,parameter::idx_PCH4j=393
  integer,parameter::idx_PC2H3j=394
  integer,parameter::idx_HSISj=395
  integer,parameter::idx_HSOj=396
  integer,parameter::idx_HNSj=397
  integer,parameter::idx_HPNj=398
  integer,parameter::idx_H2NOj=399
  integer,parameter::idx_NAH2Oj=400
  integer,parameter::idx_PH3j=401
  integer,parameter::idx_SINCHj=402
  integer,parameter::idx_HSIO2j=403
  integer,parameter::idx_HSO2j=404
  integer,parameter::idx_HC3Oj=405
  integer,parameter::idx_PC3Hj=406
  integer,parameter::idx_H3S2j=407
  integer,parameter::idx_H3SIOj=408
  integer,parameter::idx_PC4Hj=409
  integer,parameter::idx_NH2CNHj=410
  integer,parameter::idx_SIC4Hj=411
  integer,parameter::idx_SICH4j=412
  integer,parameter::idx_SIH5j=413
  integer,parameter::idx_C2H4Nj=414
  integer,parameter::idx_NH2CH2Oj=415
  integer,parameter::idx_C2H6j=416
  integer,parameter::idx_C3H4Nj=417
  integer,parameter::idx_C3H5j=418
  integer,parameter::idx_C4H4j=419
  integer,parameter::idx_CH6Nj=420
  integer,parameter::idx_C5H2Nj=421
  integer,parameter::idx_C4H4Nj=422
  integer,parameter::idx_H5C2O2j=423
  integer,parameter::idx_C2H5OH2j=424
  integer,parameter::idx_CH3OCH4j=425
  integer,parameter::idx_C7H2Nj=426
  integer,parameter::idx_C3H6OHj=427
  integer,parameter::idx_C6H4Nj=428
  integer,parameter::idx_C9H3j=429
  integer,parameter::idx_C7H5j=430
  integer,parameter::idx_C8H4Nj=431
  integer,parameter::idx_C9H2Nj=432
  integer,parameter::idx_C6H7j=433
  integer,parameter::idx_NAH2j=434
  integer,parameter::idx_PC2H4j=435
  integer,parameter::idx_C4H5j=436
  integer,parameter::idx_H2CCLj=437
  integer,parameter::idx_PC4H2j=438
  integer,parameter::idx_C6H4j=439
  integer,parameter::idx_C8H4j=440
  integer,parameter::idx_C9H4j=441
  integer,parameter::idx_C4H7j=442
  integer,parameter::idx_HC4Nj=443
  integer,parameter::idx_HC4Oj=444
  integer,parameter::idx_C5Nj=445
  integer,parameter::idx_H2C4Nj=446
  integer,parameter::idx_H3C4Nj=447
  integer,parameter::idx_C7Nj=448
  integer,parameter::idx_C5H3Nj=449
  integer,parameter::idx_C9Nj=450
  integer,parameter::idx_C7H3Nj=451
  integer,parameter::idx_C9H3Nj=452
  integer,parameter::idx_OCSjH2=453
  integer,parameter::idx_H2C3Oj=454
  integer,parameter::idx_H3C3Oj=455
  integer,parameter::idx_C5H4Nj=456
  integer,parameter::idx_C8H5j=457
  integer,parameter::idx_C9H5j=458
  integer,parameter::idx_CR=459
  integer,parameter::idx_g=460
  integer,parameter::idx_Tgas=461
  integer,parameter::idx_dummy=462
  integer,parameter::nrea=4444
  integer,parameter::nmols=458
  integer,parameter::nspec=462
