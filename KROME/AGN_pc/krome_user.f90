...
module krome_user
  ...
  integer,parameter::KROME_idx_CHOH = 208	!CHOH
  integer,parameter::KROME_idx_C_DUSTH_DUSTO_DUSTH_DUST = 209	!C_DUSTH_DUSTO_DUSTH_DUST
  integer,parameter::KROME_idx_CH2OH = 210	!CH2OH
  integer,parameter::KROME_idx_C_DUSTH_DUSTH_DUSTO_DUSTH_DUST = 211	!C_DUSTH_DUSTH_DUSTO_DUSTH_DUST
  integer,parameter::KROME_idx_C_DUSTH_DUSTH_DUSTH_DUSTO_DUSTH_DUST = 212	!C_DUSTH_DUSTH_DUSTH_DUSTO_DUSTH_DUST
  integer,parameter::KROME_idx_C_DUSTH_DUSTH_DUSTH_DUSTH_DUST = 213	!C_DUSTH_DUSTH_DUSTH_DUSTH_DUST
  integer,parameter::KROME_idx_Cj = 214	!C+
  integer,parameter::KROME_idx_FEj = 215	!FE+
  integer,parameter::KROME_idx_Hj = 216	!H+
  integer,parameter::KROME_idx_HEj = 217	!HE+
  integer,parameter::KROME_idx_MGj = 218	!MG+
  integer,parameter::KROME_idx_Nj = 219	!N+
  integer,parameter::KROME_idx_NAj = 220	!NA+
  integer,parameter::KROME_idx_Oj = 221	!O+
  integer,parameter::KROME_idx_Sj = 222	!S+
  integer,parameter::KROME_idx_SIj = 223	!SI+
  integer,parameter::KROME_idx_H3j = 224	!H3+
  integer,parameter::KROME_idx_HCOj = 225	!HCO+
  integer,parameter::KROME_idx_CLj = 226	!CL+
  integer,parameter::KROME_idx_Pj = 227	!P+
  integer,parameter::KROME_idx_COj = 228	!CO+
  integer,parameter::KROME_idx_H2j = 229	!H2+
  integer,parameter::KROME_idx_NOj = 230	!NO+
  integer,parameter::KROME_idx_O2j = 231	!O2+
  integer,parameter::KROME_idx_CH2j = 232	!CH2+
  integer,parameter::KROME_idx_H2Sj = 233	!H2S+
  integer,parameter::KROME_idx_HCSj = 234	!HCS+
  integer,parameter::KROME_idx_HNOj = 235	!HNO+
  integer,parameter::KROME_idx_NH2j = 236	!NH2+
  integer,parameter::KROME_idx_OCSj = 237	!OCS+
  integer,parameter::KROME_idx_C2H2j = 238	!C2H2+
  integer,parameter::KROME_idx_CH3j = 239	!CH3+
  integer,parameter::KROME_idx_NH3j = 240	!NH3+
  integer,parameter::KROME_idx_C2H2Oj = 241	!C2H2O+
  integer,parameter::KROME_idx_CH2O2j = 242	!CH2O2+
  integer,parameter::KROME_idx_C2H3Nj = 243	!C2H3N+
  integer,parameter::KROME_idx_C2H4j = 244	!C2H4+
  integer,parameter::KROME_idx_C4H2j = 245	!C4H2+
  integer,parameter::KROME_idx_H3COj = 246	!H3CO+
  integer,parameter::KROME_idx_CH4Oj = 247	!CH4O+
  integer,parameter::KROME_idx_C2H4Oj = 248	!C2H4O+
  integer,parameter::KROME_idx_C3H4j = 249	!C3H4+
  integer,parameter::KROME_idx_CH5Nj = 250	!CH5N+
  integer,parameter::KROME_idx_C2H5OHj = 251	!C2H5OH+
  integer,parameter::KROME_idx_CH3OCH3j = 252	!CH3OCH3+
  integer,parameter::KROME_idx_CHj = 253	!CH+
  integer,parameter::KROME_idx_CCLj = 254	!CCL+
  integer,parameter::KROME_idx_C2j = 255	!C2+
  integer,parameter::KROME_idx_CLOj = 256	!CLO+
  integer,parameter::KROME_idx_CPj = 257	!CP+
  integer,parameter::KROME_idx_CFj = 258	!CF+
  integer,parameter::KROME_idx_CSj = 259	!CS+
  integer,parameter::KROME_idx_CNj = 260	!CN+
  integer,parameter::KROME_idx_NSj = 261	!NS+
  integer,parameter::KROME_idx_PHj = 262	!PH+
  integer,parameter::KROME_idx_POj = 263	!PO+
  integer,parameter::KROME_idx_SICj = 264	!SIC+
  integer,parameter::KROME_idx_SINj = 265	!SIN+
  integer,parameter::KROME_idx_SISj = 266	!SIS+
  integer,parameter::KROME_idx_SOj = 267	!SO+
  integer,parameter::KROME_idx_C3j = 268	!C3+
  integer,parameter::KROME_idx_C2Sj = 269	!C2S+
  integer,parameter::KROME_idx_C2Oj = 270	!C2O+
  integer,parameter::KROME_idx_CCPj = 271	!CCP+
  integer,parameter::KROME_idx_C2Hj = 272	!C2H+
  integer,parameter::KROME_idx_HOCj = 273	!HOC+
  integer,parameter::KROME_idx_C2Nj = 274	!C2N+
  integer,parameter::KROME_idx_CNCj = 275	!CNC+
  integer,parameter::KROME_idx_HCPj = 276	!HCP+
  integer,parameter::KROME_idx_SIC2j = 277	!SIC2+
  integer,parameter::KROME_idx_SINCj = 278	!SINC+
  integer,parameter::KROME_idx_HPOj = 279	!HPO+
  integer,parameter::KROME_idx_HCNj = 280	!HCN+
  integer,parameter::KROME_idx_CHSIj = 281	!CHSI+
  integer,parameter::KROME_idx_SIH2j = 282	!SIH2+
  integer,parameter::KROME_idx_C3Hj = 283	!C3H+
  integer,parameter::KROME_idx_C4j = 284	!C4+
  integer,parameter::KROME_idx_C3Oj = 285	!C3O+
  integer,parameter::KROME_idx_C3Sj = 286	!C3S+
  integer,parameter::KROME_idx_H2COj = 287	!H2CO+
  integer,parameter::KROME_idx_H2SIOj = 288	!H2SIO+
  integer,parameter::KROME_idx_HCNHj = 289	!HCNH+
  integer,parameter::KROME_idx_SIC2Hj = 290	!SIC2H+
  integer,parameter::KROME_idx_SIC3j = 291	!SIC3+
  integer,parameter::KROME_idx_CH2SIj = 292	!CH2SI+
  integer,parameter::KROME_idx_SIH3j = 293	!SIH3+
  integer,parameter::KROME_idx_C2H2Nj = 294	!C2H2N+
  integer,parameter::KROME_idx_C2H3j = 295	!C2H3+
  integer,parameter::KROME_idx_C3H2j = 296	!C3H2+
  integer,parameter::KROME_idx_H2C3j = 297	!H2C3+
  integer,parameter::KROME_idx_C4Hj = 298	!C4H+
  integer,parameter::KROME_idx_C5j = 299	!C5+
  integer,parameter::KROME_idx_C4Sj = 300	!C4S+
  integer,parameter::KROME_idx_PC2Hj = 301	!PC2H+
  integer,parameter::KROME_idx_C3Nj = 302	!C3N+
  integer,parameter::KROME_idx_C4Nj = 303	!C4N+
  integer,parameter::KROME_idx_C3HNj = 304	!C3HN+
  integer,parameter::KROME_idx_HNCj = 305	!HNC+
  integer,parameter::KROME_idx_SIC3Hj = 306	!SIC3H+
  integer,parameter::KROME_idx_SIC4j = 307	!SIC4+
  integer,parameter::KROME_idx_SIC2H2j = 308	!SIC2H2+
  integer,parameter::KROME_idx_SICH3j = 309	!SICH3+
  integer,parameter::KROME_idx_HC2NCHj = 310	!HC2NCH+
  integer,parameter::KROME_idx_C3H3j = 311	!C3H3+
  integer,parameter::KROME_idx_H3C3j = 312	!H3C3+
  integer,parameter::KROME_idx_C5Hj = 313	!C5H+
  integer,parameter::KROME_idx_C6j = 314	!C6+
  integer,parameter::KROME_idx_C2H3Oj = 315	!C2H3O+
  integer,parameter::KROME_idx_C2H5j = 316	!C2H5+
  integer,parameter::KROME_idx_C3H3Nj = 317	!C3H3N+
  integer,parameter::KROME_idx_C5H2j = 318	!C5H2+
  integer,parameter::KROME_idx_C4H3j = 319	!C4H3+
  integer,parameter::KROME_idx_C6Hj = 320	!C6H+
  integer,parameter::KROME_idx_C7j = 321	!C7+
  integer,parameter::KROME_idx_CH4Nj = 322	!CH4N+
  integer,parameter::KROME_idx_C5HNj = 323	!C5HN+
  integer,parameter::KROME_idx_C7Hj = 324	!C7H+
  integer,parameter::KROME_idx_C8j = 325	!C8+
  integer,parameter::KROME_idx_COOCH4j = 326	!COOCH4+
  integer,parameter::KROME_idx_C2H5Oj = 327	!C2H5O+
  integer,parameter::KROME_idx_C8Hj = 328	!C8H+
  integer,parameter::KROME_idx_C9j = 329	!C9+
  integer,parameter::KROME_idx_C5H3j = 330	!C5H3+
  integer,parameter::KROME_idx_C6H2j = 331	!C6H2+
  integer,parameter::KROME_idx_C6H3j = 332	!C6H3+
  integer,parameter::KROME_idx_C2H6COj = 333	!C2H6CO+
  integer,parameter::KROME_idx_C9Hj = 334	!C9H+
  integer,parameter::KROME_idx_C10j = 335	!C10+
  integer,parameter::KROME_idx_C7H3j = 336	!C7H3+
  integer,parameter::KROME_idx_C8H2j = 337	!C8H2+
  integer,parameter::KROME_idx_C8H3j = 338	!C8H3+
  integer,parameter::KROME_idx_HCLj = 339	!HCL+
  integer,parameter::KROME_idx_Fj = 340	!F+
  integer,parameter::KROME_idx_HFj = 341	!HF+
  integer,parameter::KROME_idx_HSj = 342	!HS+
  integer,parameter::KROME_idx_NHj = 343	!NH+
  integer,parameter::KROME_idx_OHj = 344	!OH+
  integer,parameter::KROME_idx_PNj = 345	!PN+
  integer,parameter::KROME_idx_S2j = 346	!S2+
  integer,parameter::KROME_idx_SIHj = 347	!SIH+
  integer,parameter::KROME_idx_SIOj = 348	!SIO+
  integer,parameter::KROME_idx_H2Oj = 349	!H2O+
  integer,parameter::KROME_idx_HNSIj = 350	!HNSI+
  integer,parameter::KROME_idx_S2Hj = 351	!S2H+
  integer,parameter::KROME_idx_PH2j = 352	!PH2+
  integer,parameter::KROME_idx_H2CSj = 353	!H2CS+
  integer,parameter::KROME_idx_H2S2j = 354	!H2S2+
  integer,parameter::KROME_idx_HSIOj = 355	!HSIO+
  integer,parameter::KROME_idx_C4Pj = 356	!C4P+
  integer,parameter::KROME_idx_HCO2j = 357	!HCO2+
  integer,parameter::KROME_idx_PCH3j = 358	!PCH3+
  integer,parameter::KROME_idx_CH4j = 359	!CH4+
  integer,parameter::KROME_idx_C2NHj = 360	!C2NH+
  integer,parameter::KROME_idx_SIH4j = 361	!SIH4+
  integer,parameter::KROME_idx_NH4j = 362	!NH4+
  integer,parameter::KROME_idx_H2NCj = 363	!H2NC+
  integer,parameter::KROME_idx_C3H2Nj = 364	!C3H2N+
  integer,parameter::KROME_idx_C7H2j = 365	!C7H2+
  integer,parameter::KROME_idx_C5H4j = 366	!C5H4+
  integer,parameter::KROME_idx_C7HNj = 367	!C7HN+
  integer,parameter::KROME_idx_C9H2j = 368	!C9H2+
  integer,parameter::KROME_idx_C7H4j = 369	!C7H4+
  integer,parameter::KROME_idx_C9HNj = 370	!C9HN+
  integer,parameter::KROME_idx_N2j = 371	!N2+
  integer,parameter::KROME_idx_CO2j = 372	!CO2+
  integer,parameter::KROME_idx_HEHj = 373	!HEH+
  integer,parameter::KROME_idx_SO2j = 374	!SO2+
  integer,parameter::KROME_idx_C6H5j = 375	!C6H5+
  integer,parameter::KROME_idx_C5H5j = 376	!C5H5+
  integer,parameter::KROME_idx_N2Hj = 377	!N2H+
  integer,parameter::KROME_idx_NO2j = 378	!NO2+
  integer,parameter::KROME_idx_PC2H2j = 379	!PC2H2+
  integer,parameter::KROME_idx_PNH2j = 380	!PNH2+
  integer,parameter::KROME_idx_PCH2j = 381	!PCH2+
  integer,parameter::KROME_idx_HC2Sj = 382	!HC2S+
  integer,parameter::KROME_idx_HC3Sj = 383	!HC3S+
  integer,parameter::KROME_idx_H3CSj = 384	!H3CS+
  integer,parameter::KROME_idx_HC4Sj = 385	!HC4S+
  integer,parameter::KROME_idx_SIFj = 386	!SIF+
  integer,parameter::KROME_idx_SINH2j = 387	!SINH2+
  integer,parameter::KROME_idx_SIC2H3j = 388	!SIC2H3+
  integer,parameter::KROME_idx_SIC3H2j = 389	!SIC3H2+
  integer,parameter::KROME_idx_C2HOj = 390	!C2HO+
  integer,parameter::KROME_idx_H3Oj = 391	!H3O+
  integer,parameter::KROME_idx_H3Sj = 392	!H3S+
  integer,parameter::KROME_idx_HOCSj = 393	!HOCS+
  integer,parameter::KROME_idx_CH5Oj = 394	!CH5O+
  integer,parameter::KROME_idx_NCOj = 395	!NCO+
  integer,parameter::KROME_idx_HNCOj = 396	!HNCO+
  integer,parameter::KROME_idx_C2N2j = 397	!C2N2+
  integer,parameter::KROME_idx_O2Hj = 398	!O2H+
  integer,parameter::KROME_idx_CH5j = 399	!CH5+
  integer,parameter::KROME_idx_H2CLj = 400	!H2CL+
  integer,parameter::KROME_idx_H2Fj = 401	!H2F+
  integer,parameter::KROME_idx_CH3O2j = 402	!CH3O2+
  integer,parameter::KROME_idx_H2POj = 403	!H2PO+
  integer,parameter::KROME_idx_PNH3j = 404	!PNH3+
  integer,parameter::KROME_idx_PCH4j = 405	!PCH4+
  integer,parameter::KROME_idx_PC2H3j = 406	!PC2H3+
  integer,parameter::KROME_idx_HSISj = 407	!HSIS+
  integer,parameter::KROME_idx_HSOj = 408	!HSO+
  integer,parameter::KROME_idx_HNSj = 409	!HNS+
  integer,parameter::KROME_idx_HPNj = 410	!HPN+
  integer,parameter::KROME_idx_H2NOj = 411	!H2NO+
  integer,parameter::KROME_idx_NAH2Oj = 412	!NAH2O+
  integer,parameter::KROME_idx_PH3j = 413	!PH3+
  integer,parameter::KROME_idx_SINCHj = 414	!SINCH+
  integer,parameter::KROME_idx_HSIO2j = 415	!HSIO2+
  integer,parameter::KROME_idx_HSO2j = 416	!HSO2+
  integer,parameter::KROME_idx_HC3Oj = 417	!HC3O+
  integer,parameter::KROME_idx_PC3Hj = 418	!PC3H+
  integer,parameter::KROME_idx_H3S2j = 419	!H3S2+
  integer,parameter::KROME_idx_H3SIOj = 420	!H3SIO+
  integer,parameter::KROME_idx_PC4Hj = 421	!PC4H+
  integer,parameter::KROME_idx_NH2CNHj = 422	!NH2CNH+
  integer,parameter::KROME_idx_SIC4Hj = 423	!SIC4H+
  integer,parameter::KROME_idx_SICH4j = 424	!SICH4+
  integer,parameter::KROME_idx_SIH5j = 425	!SIH5+
  integer,parameter::KROME_idx_C2H4Nj = 426	!C2H4N+
  integer,parameter::KROME_idx_NH2CH2Oj = 427	!NH2CH2O+
  integer,parameter::KROME_idx_C2H6j = 428	!C2H6+
  integer,parameter::KROME_idx_C3H4Nj = 429	!C3H4N+
  integer,parameter::KROME_idx_C3H5j = 430	!C3H5+
  integer,parameter::KROME_idx_C4H4j = 431	!C4H4+
  integer,parameter::KROME_idx_CH6Nj = 432	!CH6N+
  integer,parameter::KROME_idx_C5H2Nj = 433	!C5H2N+
  integer,parameter::KROME_idx_C4H4Nj = 434	!C4H4N+
  integer,parameter::KROME_idx_H5C2O2j = 435	!H5C2O2+
  integer,parameter::KROME_idx_C2H5OH2j = 436	!C2H5OH2+
  integer,parameter::KROME_idx_CH3OCH4j = 437	!CH3OCH4+
  integer,parameter::KROME_idx_C7H2Nj = 438	!C7H2N+
  integer,parameter::KROME_idx_C3H6OHj = 439	!C3H6OH+
  integer,parameter::KROME_idx_C6H4Nj = 440	!C6H4N+
  integer,parameter::KROME_idx_C9H3j = 441	!C9H3+
  integer,parameter::KROME_idx_C7H5j = 442	!C7H5+
  integer,parameter::KROME_idx_C8H4Nj = 443	!C8H4N+
  integer,parameter::KROME_idx_C9H2Nj = 444	!C9H2N+
  integer,parameter::KROME_idx_C6H7j = 445	!C6H7+
  integer,parameter::KROME_idx_NAH2j = 446	!NAH2+
  integer,parameter::KROME_idx_PC2H4j = 447	!PC2H4+
  integer,parameter::KROME_idx_C4H5j = 448	!C4H5+
  integer,parameter::KROME_idx_H2CCLj = 449	!H2CCL+
  integer,parameter::KROME_idx_PC4H2j = 450	!PC4H2+
  integer,parameter::KROME_idx_C6H4j = 451	!C6H4+
  integer,parameter::KROME_idx_C8H4j = 452	!C8H4+
  integer,parameter::KROME_idx_C9H4j = 453	!C9H4+
  integer,parameter::KROME_idx_C4H7j = 454	!C4H7+
  integer,parameter::KROME_idx_HC4Nj = 455	!HC4N+
  integer,parameter::KROME_idx_HC4Oj = 456	!HC4O+
  integer,parameter::KROME_idx_C5Nj = 457	!C5N+
  integer,parameter::KROME_idx_H2C4Nj = 458	!H2C4N+
  integer,parameter::KROME_idx_H3C4Nj = 459	!H3C4N+
  integer,parameter::KROME_idx_C7Nj = 460	!C7N+
  integer,parameter::KROME_idx_C5H3Nj = 461	!C5H3N+
  integer,parameter::KROME_idx_C9Nj = 462	!C9N+
  integer,parameter::KROME_idx_C7H3Nj = 463	!C7H3N+
  integer,parameter::KROME_idx_C9H3Nj = 464	!C9H3N+
  integer,parameter::KROME_idx_OCSjH2 = 465	!OCS+H2
  integer,parameter::KROME_idx_H2C3Oj = 466	!H2C3O+
  integer,parameter::KROME_idx_H3C3Oj = 467	!H3C3O+
  integer,parameter::KROME_idx_C5H4Nj = 468	!C5H4N+
  integer,parameter::KROME_idx_C8H5j = 469	!C8H5+
  integer,parameter::KROME_idx_C9H5j = 470	!C9H5+
  integer,parameter::KROME_idx_CR = 471	!CR
  integer,parameter::KROME_idx_g = 472	!g
  integer,parameter::KROME_idx_Tgas = 473	!Tgas
  integer,parameter::KROME_idx_dummy = 474	!dummy
  ...
  integer,parameter::krome_nrea=4475
  integer,parameter::krome_nmols=470
  integer,parameter::krome_nspec=474
...
contains
  ...
  function krome_get_names_header()
    ...
    use krome_getphys
    implicit none
    character*2631::krome_get_names_header
    character*16::tmp(nspec)
    integer::i
