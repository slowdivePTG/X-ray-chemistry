subroutine trace(neq,tt,nin,FILE)
  ...
  dn(idx_E) = &
      ...
      -k(3850)*n(idx_C2H2Nj)*n(idx_E) &
      -k(3851)*n(idx_C2H2Nj)*n(idx_E) &
      -k(3852)*n(idx_C2H2Nj)*n(idx_E) &
      ...
      -k(3930)*n(idx_C2H3Nj)*n(idx_E) &
      -k(3931)*n(idx_C2H3Nj)*n(idx_E) &
      -k(3932)*n(idx_C2H3Nj)*n(idx_E) &
      -k(3933)*n(idx_C2H3Nj)*n(idx_E) &
  ...
  dn(idx_HE) = &
      ...
      +k(848)*n(idx_HEj)*n(idx_SIH4) &
      +k(849)*n(idx_HEj)*n(idx_C2H3N) &
      +k(850)*n(idx_HEj)*n(idx_C2H3N) &
      +k(851)*n(idx_HEj)*n(idx_C2H4) &
  ...
  dn(idx_CO2) = &
      ...
      +k(2506)*n(idx_HCO2j)*n(idx_C2H3N) &
