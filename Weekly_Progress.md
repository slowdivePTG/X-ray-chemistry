...
3. Discussion with Prof. Du
   ...
   2. UV backgrounds is also important in our model. Rate coefficients for photo-processes by UV photons are normally computed as a function of the visual extinction $A_v$
      $$
...
2. Fixed column densities for clouds ($N_\ce{H}=10^{22}, 10^{22.5}, 10^{23}$ cm$^{-2}$)
   - UV extinction - $A_V=5.3,\ 16.7,\ 53$
