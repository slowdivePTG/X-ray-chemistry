...
3. Discussion with Prof. Du
   ...
   2. UV backgrounds is also important in our model. Rate coefficients for photo-processes by UV photons
      are normally computed as a function of the visual extinction $A_v$
      $$
